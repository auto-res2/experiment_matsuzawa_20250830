...
- Saves all figures as PDF under .research/iteration12/images.
"""
...
def timewarp_discover_toy(n_steps: int = 10, K: int = 3, image_shape: Tuple[int, int] = (64, 64), images_out_dir: str = ".research/iteration12/images") -> List[int]:
