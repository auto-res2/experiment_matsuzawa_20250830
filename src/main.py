...
- All figures are saved as PDF under .research/iteration10/images.
...
def load_config(path: str) -> Dict[str, Any]:
    if not os.path.exists(path):
        ...
        return {
            ...
            "images_out_dir": ".research/iteration10/images",
...
def main():
    ...
    images_out_dir = cfg.get("images_out_dir", ".research/iteration10/images")
